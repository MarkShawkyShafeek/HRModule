...
{
	public abstract class _ContractType : SqlClientEntity
	{
		public _ContractType()
		{
			this.QuerySource = "ContractType";
			this.MappingName = "ContractType";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ContractTypeLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int ID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ContractTypeLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter Type
			{
				get
				{
					return new SqlParameter("@Type", SqlDbType.NVarChar, 50);
				}
			}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _ContractType.PropertyNames.ID;
					ht[Type] = _ContractType.PropertyNames.Type;
					ht[CreationDate] = _ContractType.PropertyNames.CreationDate;
					ht[CreatedBy] = _ContractType.PropertyNames.CreatedBy;
					ht[ModifiedDate] = _ContractType.PropertyNames.ModifiedDate;
					ht[ModifiedBy] = _ContractType.PropertyNames.ModifiedBy;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _ContractType.ColumnNames.ID;
					ht[Type] = _ContractType.ColumnNames.Type;
					ht[CreationDate] = _ContractType.ColumnNames.CreationDate;
					ht[CreatedBy] = _ContractType.ColumnNames.CreatedBy;
					ht[ModifiedDate] = _ContractType.ColumnNames.ModifiedDate;
					ht[ModifiedBy] = _ContractType.ColumnNames.ModifiedBy;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ContractTypeInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ContractTypeUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ContractTypeDelete]";
