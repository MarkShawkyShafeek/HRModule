...
{
	public abstract class _UserPhone : SqlClientEntity
	{
		public _UserPhone()
		{
			this.QuerySource = "UserPhone";
			this.MappingName = "UserPhone";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_UserPhoneLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int ID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_UserPhoneLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter Number
			{
				get
				{
					return new SqlParameter("@Number", SqlDbType.NVarChar, 50);
				}
			}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _UserPhone.PropertyNames.ID;
					ht[Number] = _UserPhone.PropertyNames.Number;
					ht[CreationDate] = _UserPhone.PropertyNames.CreationDate;
					ht[CreatedBy] = _UserPhone.PropertyNames.CreatedBy;
					ht[ModifiedDate] = _UserPhone.PropertyNames.ModifiedDate;
					ht[ModifiedBy] = _UserPhone.PropertyNames.ModifiedBy;
					ht[EmpID] = _UserPhone.PropertyNames.EmpID;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _UserPhone.ColumnNames.ID;
					ht[Number] = _UserPhone.ColumnNames.Number;
					ht[CreationDate] = _UserPhone.ColumnNames.CreationDate;
					ht[CreatedBy] = _UserPhone.ColumnNames.CreatedBy;
					ht[ModifiedDate] = _UserPhone.ColumnNames.ModifiedDate;
					ht[ModifiedBy] = _UserPhone.ColumnNames.ModifiedBy;
					ht[EmpID] = _UserPhone.ColumnNames.EmpID;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_UserPhoneInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_UserPhoneUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_UserPhoneDelete]";
