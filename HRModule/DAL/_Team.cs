...
{
	public abstract class _Team : SqlClientEntity
	{
		public _Team()
		{
			this.QuerySource = "Team";
			this.MappingName = "Team";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_TeamLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int ID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_TeamLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter DodifiedDate
			{
				get
				{
					return new SqlParameter("@DodifiedDate", SqlDbType.DateTime, 0);
				}
			}
		...
		{  
            ...
            public const string DodifiedDate = "DodifiedDate";
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _Team.PropertyNames.ID;
					ht[Name] = _Team.PropertyNames.Name;
					ht[DepartmentID] = _Team.PropertyNames.DepartmentID;
					ht[CreationDate] = _Team.PropertyNames.CreationDate;
					ht[CreatedBy] = _Team.PropertyNames.CreatedBy;
					ht[DodifiedDate] = _Team.PropertyNames.DodifiedDate;
					ht[ModifiedBy] = _Team.PropertyNames.ModifiedBy;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _Team.ColumnNames.ID;
					ht[Name] = _Team.ColumnNames.Name;
					ht[DepartmentID] = _Team.ColumnNames.DepartmentID;
					ht[CreationDate] = _Team.ColumnNames.CreationDate;
					ht[CreatedBy] = _Team.ColumnNames.CreatedBy;
					ht[DodifiedDate] = _Team.ColumnNames.DodifiedDate;
					ht[ModifiedBy] = _Team.ColumnNames.ModifiedBy;
		...
		{  
            ...
            public const string DodifiedDate = "s_DodifiedDate";
		...
		public virtual DateTime DodifiedDate
	    {
			get
	        {
				return base.GetDateTime(ColumnNames.DodifiedDate);
			}
			set
	        {
				base.SetDateTime(ColumnNames.DodifiedDate, value);
			}
		}
		...
		public virtual string s_DodifiedDate
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.DodifiedDate) ? string.Empty : base.GetDateTimeAsString(ColumnNames.DodifiedDate);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.DodifiedDate);
				else
					this.DodifiedDate = base.SetDateTimeAsString(ColumnNames.DodifiedDate, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter DodifiedDate
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.DodifiedDate, Parameters.DodifiedDate);
							this._clause._entity.Query.AddWhereParameter(where);
							return where;
					}
				}
			...
			public WhereParameter DodifiedDate
		    {
				get
		        {
					if(_DodifiedDate_W == null)
	        	    {
						_DodifiedDate_W = TearOff.DodifiedDate;
					}
					return _DodifiedDate_W;
				}
			}
			...
			private WhereParameter _DodifiedDate_W = null;
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter DodifiedDate
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.DodifiedDate, Parameters.DodifiedDate);
							this._clause._entity.Query.AddAggregateParameter(aggregate);
							return aggregate;
					}
				}
			...
			private AggregateParameter _DodifiedDate_W = null;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_TeamInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_TeamUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_TeamDelete]";
		...
		private IDbCommand CreateParameters(SqlCommand cmd)
		{
			...
			p = cmd.Parameters.Add(Parameters.DodifiedDate);
			p.SourceColumn = ColumnNames.DodifiedDate;
			p.SourceVersion = DataRowVersion.Current;
