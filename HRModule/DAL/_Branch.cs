...
namespace HRModule
{
	public abstract class _Branch : SqlClientEntity
	{
		public _Branch()
		{
			this.QuerySource = "Branch";
			this.MappingName = "Branch";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_BranchLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int ID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_BranchLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _Branch.PropertyNames.ID;
					ht[Name] = _Branch.PropertyNames.Name;
					ht[Phone] = _Branch.PropertyNames.Phone;
					ht[Description] = _Branch.PropertyNames.Description;
					ht[CreationDate] = _Branch.PropertyNames.CreationDate;
					ht[CreatedBy] = _Branch.PropertyNames.CreatedBy;
					ht[ModifiedDate] = _Branch.PropertyNames.ModifiedDate;
					ht[ModifiedBy] = _Branch.PropertyNames.ModifiedBy;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _Branch.ColumnNames.ID;
					ht[Name] = _Branch.ColumnNames.Name;
					ht[Phone] = _Branch.ColumnNames.Phone;
					ht[Description] = _Branch.ColumnNames.Description;
					ht[CreationDate] = _Branch.ColumnNames.CreationDate;
					ht[CreatedBy] = _Branch.ColumnNames.CreatedBy;
					ht[ModifiedDate] = _Branch.ColumnNames.ModifiedDate;
					ht[ModifiedBy] = _Branch.ColumnNames.ModifiedBy;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_BranchInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_BranchUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_BranchDelete]";
