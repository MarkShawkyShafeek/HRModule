...
{
	public abstract class _Currency : SqlClientEntity
	{
		public _Currency()
		{
			this.QuerySource = "Currency";
			this.MappingName = "Currency";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_CurrencyLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int ID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_CurrencyLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _Currency.PropertyNames.ID;
					ht[Name] = _Currency.PropertyNames.Name;
					ht[CreationDate] = _Currency.PropertyNames.CreationDate;
					ht[CreatedBy] = _Currency.PropertyNames.CreatedBy;
					ht[ModifiedDate] = _Currency.PropertyNames.ModifiedDate;
					ht[ModifiedBy] = _Currency.PropertyNames.ModifiedBy;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _Currency.ColumnNames.ID;
					ht[Name] = _Currency.ColumnNames.Name;
					ht[CreationDate] = _Currency.ColumnNames.CreationDate;
					ht[CreatedBy] = _Currency.ColumnNames.CreatedBy;
					ht[ModifiedDate] = _Currency.ColumnNames.ModifiedDate;
					ht[ModifiedBy] = _Currency.ColumnNames.ModifiedBy;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_CurrencyInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_CurrencyUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_CurrencyDelete]";
