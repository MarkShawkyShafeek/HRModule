...
{
	public abstract class _UserTax : SqlClientEntity
	{
		public _UserTax()
		{
			this.QuerySource = "UserTax";
			this.MappingName = "UserTax";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_UserTaxLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int ID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_UserTaxLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter Percentage
			{
				get
				{
					return new SqlParameter("@Percentage", SqlDbType.Float, 0);
				}
			}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _UserTax.PropertyNames.ID;
					ht[EmpID] = _UserTax.PropertyNames.EmpID;
					ht[Percentage] = _UserTax.PropertyNames.Percentage;
					ht[Amount] = _UserTax.PropertyNames.Amount;
					ht[CreationDate] = _UserTax.PropertyNames.CreationDate;
					ht[CreatedBy] = _UserTax.PropertyNames.CreatedBy;
					ht[ModifiedDate] = _UserTax.PropertyNames.ModifiedDate;
					ht[ModifiedBy] = _UserTax.PropertyNames.ModifiedBy;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _UserTax.ColumnNames.ID;
					ht[EmpID] = _UserTax.ColumnNames.EmpID;
					ht[Percentage] = _UserTax.ColumnNames.Percentage;
					ht[Amount] = _UserTax.ColumnNames.Amount;
					ht[CreationDate] = _UserTax.ColumnNames.CreationDate;
					ht[CreatedBy] = _UserTax.ColumnNames.CreatedBy;
					ht[ModifiedDate] = _UserTax.ColumnNames.ModifiedDate;
					ht[ModifiedBy] = _UserTax.ColumnNames.ModifiedBy;
		...
		{  
            ...
            public const string Percentage = "s_Percentage";
		...
		public virtual double Percentage
	    {
			get
	        {
				return base.Getdouble(ColumnNames.Percentage);
			}
			set
	        {
				base.Setdouble(ColumnNames.Percentage, value);
			}
		}
		...
		public virtual string s_Percentage
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.Percentage) ? string.Empty : base.GetdoubleAsString(ColumnNames.Percentage);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.Percentage);
				else
					this.Percentage = base.SetdoubleAsString(ColumnNames.Percentage, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter Percentage
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.Percentage, Parameters.Percentage);
							this._clause._entity.Query.AddWhereParameter(where);
							return where;
					}
				}
			...
			public WhereParameter Percentage
		    {
				get
		        {
					if(_Percentage_W == null)
	        	    {
						_Percentage_W = TearOff.Percentage;
					}
					return _Percentage_W;
				}
			}
			...
			private WhereParameter _Percentage_W = null;
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter Percentage
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.Percentage, Parameters.Percentage);
							this._clause._entity.Query.AddAggregateParameter(aggregate);
							return aggregate;
					}
				}
			...
			private AggregateParameter _Percentage_W = null;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_UserTaxInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_UserTaxUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_UserTaxDelete]";
		...
		private IDbCommand CreateParameters(SqlCommand cmd)
		{
			...
			p = cmd.Parameters.Add(Parameters.Percentage);
			p.SourceColumn = ColumnNames.Percentage;
			p.SourceVersion = DataRowVersion.Current;
