...
{
	public abstract class _MaritalStatus : SqlClientEntity
	{
		public _MaritalStatus()
		{
			this.QuerySource = "MaritalStatus";
			this.MappingName = "MaritalStatus";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_MaritalStatusLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int ID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_MaritalStatusLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter MaritalStatus
			{
				get
				{
					return new SqlParameter("@MaritalStatus", SqlDbType.NVarChar, 50);
				}
			}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _MaritalStatus.PropertyNames.ID;
					ht[MaritalStatus] = _MaritalStatus.PropertyNames.MaritalStatus;
					ht[CreationDate] = _MaritalStatus.PropertyNames.CreationDate;
					ht[CreatedBy] = _MaritalStatus.PropertyNames.CreatedBy;
					ht[ModifiedDate] = _MaritalStatus.PropertyNames.ModifiedDate;
					ht[ModifiedBy] = _MaritalStatus.PropertyNames.ModifiedBy;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _MaritalStatus.ColumnNames.ID;
					ht[MaritalStatus] = _MaritalStatus.ColumnNames.MaritalStatus;
					ht[CreationDate] = _MaritalStatus.ColumnNames.CreationDate;
					ht[CreatedBy] = _MaritalStatus.ColumnNames.CreatedBy;
					ht[ModifiedDate] = _MaritalStatus.ColumnNames.ModifiedDate;
					ht[ModifiedBy] = _MaritalStatus.ColumnNames.ModifiedBy;
		...
		public virtual string MaritalStatus
	    {
			get
	        {
				return base.Getstring(ColumnNames.MaritalStatus);
			}
			set
	        {
				base.Setstring(ColumnNames.MaritalStatus, value);
			}
		}
		...
		public virtual string s_MaritalStatus
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.MaritalStatus) ? string.Empty : base.GetstringAsString(ColumnNames.MaritalStatus);
			}
			set
	        {
				if(string.Empty == value)
					...
					this.MaritalStatus = base.SetstringAsString(ColumnNames.MaritalStatus, value);
			}
		}
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_MaritalStatusInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_MaritalStatusUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_MaritalStatusDelete]";
