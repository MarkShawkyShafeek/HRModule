...
{
	public abstract class _UserEmail : SqlClientEntity
	{
		public _UserEmail()
		{
			this.QuerySource = "UserEmail";
			this.MappingName = "UserEmail";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_UserEmailLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(long ID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_UserEmailLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _UserEmail.PropertyNames.ID;
					ht[Email] = _UserEmail.PropertyNames.Email;
					ht[CreationDate] = _UserEmail.PropertyNames.CreationDate;
					ht[CreatedBy] = _UserEmail.PropertyNames.CreatedBy;
					ht[ModifiedDate] = _UserEmail.PropertyNames.ModifiedDate;
					ht[ModifiedBy] = _UserEmail.PropertyNames.ModifiedBy;
					ht[EmpID] = _UserEmail.PropertyNames.EmpID;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _UserEmail.ColumnNames.ID;
					ht[Email] = _UserEmail.ColumnNames.Email;
					ht[CreationDate] = _UserEmail.ColumnNames.CreationDate;
					ht[CreatedBy] = _UserEmail.ColumnNames.CreatedBy;
					ht[ModifiedDate] = _UserEmail.ColumnNames.ModifiedDate;
					ht[ModifiedBy] = _UserEmail.ColumnNames.ModifiedBy;
					ht[EmpID] = _UserEmail.ColumnNames.EmpID;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_UserEmailInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_UserEmailUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_UserEmailDelete]";
