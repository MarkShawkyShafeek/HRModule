...
{
	public abstract class _PaymentStrategy : SqlClientEntity
	{
		public _PaymentStrategy()
		{
			this.QuerySource = "PaymentStrategy";
			this.MappingName = "PaymentStrategy";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_PaymentStrategyLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int ID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_PaymentStrategyLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter Strategy
			{
				get
				{
					return new SqlParameter("@Strategy", SqlDbType.NVarChar, 50);
				}
			}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _PaymentStrategy.PropertyNames.ID;
					ht[Strategy] = _PaymentStrategy.PropertyNames.Strategy;
					ht[CreationDate] = _PaymentStrategy.PropertyNames.CreationDate;
					ht[CreatedBy] = _PaymentStrategy.PropertyNames.CreatedBy;
					ht[ModifiedDate] = _PaymentStrategy.PropertyNames.ModifiedDate;
					ht[ModifiedBy] = _PaymentStrategy.PropertyNames.ModifiedBy;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _PaymentStrategy.ColumnNames.ID;
					ht[Strategy] = _PaymentStrategy.ColumnNames.Strategy;
					ht[CreationDate] = _PaymentStrategy.ColumnNames.CreationDate;
					ht[CreatedBy] = _PaymentStrategy.ColumnNames.CreatedBy;
					ht[ModifiedDate] = _PaymentStrategy.ColumnNames.ModifiedDate;
					ht[ModifiedBy] = _PaymentStrategy.ColumnNames.ModifiedBy;
		...
		{  
            ...
            public const string Strategy = "s_Strategy";
		...
		public virtual string Strategy
	    {
			get
	        {
				return base.Getstring(ColumnNames.Strategy);
			}
			set
	        {
				base.Setstring(ColumnNames.Strategy, value);
			}
		}
		...
		public virtual string s_Strategy
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.Strategy) ? string.Empty : base.GetstringAsString(ColumnNames.Strategy);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.Strategy);
				else
					this.Strategy = base.SetstringAsString(ColumnNames.Strategy, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter Strategy
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.Strategy, Parameters.Strategy);
							this._clause._entity.Query.AddWhereParameter(where);
							return where;
					}
				}
			...
			private WhereParameter _Strategy_W = null;
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter Strategy
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.Strategy, Parameters.Strategy);
							this._clause._entity.Query.AddAggregateParameter(aggregate);
							return aggregate;
					}
				}
			...
			private AggregateParameter _Strategy_W = null;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_PaymentStrategyInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_PaymentStrategyUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_PaymentStrategyDelete]";
		...
		private IDbCommand CreateParameters(SqlCommand cmd)
		{
			...
			p = cmd.Parameters.Add(Parameters.Strategy);
			p.SourceColumn = ColumnNames.Strategy;
			p.SourceVersion = DataRowVersion.Current;
