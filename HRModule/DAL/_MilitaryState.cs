...
{
	public abstract class _MilitaryState : SqlClientEntity
	{
		public _MilitaryState()
		{
			this.QuerySource = "MilitaryState";
			this.MappingName = "MilitaryState";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_MilitaryStateLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int ID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_MilitaryStateLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter MilitaryState
			{
				get
				{
					return new SqlParameter("@MilitaryState", SqlDbType.NVarChar, 50);
				}
			}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _MilitaryState.PropertyNames.ID;
					ht[MilitaryState] = _MilitaryState.PropertyNames.MilitaryState;
					ht[CreationDate] = _MilitaryState.PropertyNames.CreationDate;
					ht[CreatedBy] = _MilitaryState.PropertyNames.CreatedBy;
					ht[ModifiedDate] = _MilitaryState.PropertyNames.ModifiedDate;
					ht[ModifiedBy] = _MilitaryState.PropertyNames.ModifiedBy;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _MilitaryState.ColumnNames.ID;
					ht[MilitaryState] = _MilitaryState.ColumnNames.MilitaryState;
					ht[CreationDate] = _MilitaryState.ColumnNames.CreationDate;
					ht[CreatedBy] = _MilitaryState.ColumnNames.CreatedBy;
					ht[ModifiedDate] = _MilitaryState.ColumnNames.ModifiedDate;
					ht[ModifiedBy] = _MilitaryState.ColumnNames.ModifiedBy;
		...
		public virtual string MilitaryState
	    {
			get
	        {
				return base.Getstring(ColumnNames.MilitaryState);
			}
			set
	        {
				base.Setstring(ColumnNames.MilitaryState, value);
			}
		}
		...
		public virtual string s_MilitaryState
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.MilitaryState) ? string.Empty : base.GetstringAsString(ColumnNames.MilitaryState);
			}
			set
	        {
				if(string.Empty == value)
					...
					this.MilitaryState = base.SetstringAsString(ColumnNames.MilitaryState, value);
			}
		}
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_MilitaryStateInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_MilitaryStateUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_MilitaryStateDelete]";
