...
{
	public abstract class _ExtraFinancial : SqlClientEntity
	{
		public _ExtraFinancial()
		{
			this.QuerySource = "ExtraFinancial";
			this.MappingName = "ExtraFinancial";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ExtraFinancialLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int ID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ExtraFinancialLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter Allowances
			{
				get
				{
					return new SqlParameter("@Allowances", SqlDbType.NVarChar, 50);
				}
			}
			...
			public static SqlParameter CalculationMethodID
			{
				get
				{
					return new SqlParameter("@CalculationMethodID", SqlDbType.Int, 0);
				}
			}
		...
		{  
            ...
            public const string CalculationMethodID = "CalculationMethodID";
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _ExtraFinancial.PropertyNames.ID;
					ht[Allowances] = _ExtraFinancial.PropertyNames.Allowances;
					ht[EmpID] = _ExtraFinancial.PropertyNames.EmpID;
					ht[CalculationMethodID] = _ExtraFinancial.PropertyNames.CalculationMethodID;
					ht[Amount] = _ExtraFinancial.PropertyNames.Amount;
					ht[CreationDate] = _ExtraFinancial.PropertyNames.CreationDate;
					ht[CreatedBy] = _ExtraFinancial.PropertyNames.CreatedBy;
					ht[ModifiedDate] = _ExtraFinancial.PropertyNames.ModifiedDate;
					ht[ModifiedBy] = _ExtraFinancial.PropertyNames.ModifiedBy;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _ExtraFinancial.ColumnNames.ID;
					ht[Allowances] = _ExtraFinancial.ColumnNames.Allowances;
					ht[EmpID] = _ExtraFinancial.ColumnNames.EmpID;
					ht[CalculationMethodID] = _ExtraFinancial.ColumnNames.CalculationMethodID;
					ht[Amount] = _ExtraFinancial.ColumnNames.Amount;
					ht[CreationDate] = _ExtraFinancial.ColumnNames.CreationDate;
					ht[CreatedBy] = _ExtraFinancial.ColumnNames.CreatedBy;
					ht[ModifiedDate] = _ExtraFinancial.ColumnNames.ModifiedDate;
					ht[ModifiedBy] = _ExtraFinancial.ColumnNames.ModifiedBy;
		...
		{  
            ...
            public const string Allowances = "s_Allowances";
            public const string EmpID = "s_EmpID";
            public const string CalculationMethodID = "s_CalculationMethodID";
		...
		public virtual string Allowances
	    {
			get
	        {
				return base.Getstring(ColumnNames.Allowances);
			}
			set
	        {
				base.Setstring(ColumnNames.Allowances, value);
			}
		}
		...
		public virtual int CalculationMethodID
	    {
			get
	        {
				return base.Getint(ColumnNames.CalculationMethodID);
			}
			set
	        {
				base.Setint(ColumnNames.CalculationMethodID, value);
			}
		}
		...
		public virtual string s_Allowances
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.Allowances) ? string.Empty : base.GetstringAsString(ColumnNames.Allowances);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.Allowances);
				else
					this.Allowances = base.SetstringAsString(ColumnNames.Allowances, value);
			}
		}
		...
		public virtual string s_CalculationMethodID
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.CalculationMethodID) ? string.Empty : base.GetintAsString(ColumnNames.CalculationMethodID);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.CalculationMethodID);
				else
					this.CalculationMethodID = base.SetintAsString(ColumnNames.CalculationMethodID, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter Allowances
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.Allowances, Parameters.Allowances);
							this._clause._entity.Query.AddWhereParameter(where);
							return where;
					}
				}
				...
				public WhereParameter CalculationMethodID
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.CalculationMethodID, Parameters.CalculationMethodID);
							this._clause._entity.Query.AddWhereParameter(where);
							return where;
					}
				}
			...
			public WhereParameter Allowances
		    {
				get
		        {
					if(_Allowances_W == null)
	        	    {
						_Allowances_W = TearOff.Allowances;
					}
					return _Allowances_W;
				}
			}
			...
			public WhereParameter CalculationMethodID
		    {
				get
		        {
					if(_CalculationMethodID_W == null)
	        	    {
						_CalculationMethodID_W = TearOff.CalculationMethodID;
					}
					return _CalculationMethodID_W;
				}
			}
			...
			private WhereParameter _Allowances_W = null;
			private WhereParameter _EmpID_W = null;
			private WhereParameter _CalculationMethodID_W = null;
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter Allowances
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.Allowances, Parameters.Allowances);
							this._clause._entity.Query.AddAggregateParameter(aggregate);
							return aggregate;
					}
				}
				...
				public AggregateParameter CalculationMethodID
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.CalculationMethodID, Parameters.CalculationMethodID);
							this._clause._entity.Query.AddAggregateParameter(aggregate);
							return aggregate;
					}
				}
			...
			private AggregateParameter _Allowances_W = null;
			private AggregateParameter _EmpID_W = null;
			private AggregateParameter _CalculationMethodID_W = null;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ExtraFinancialInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ExtraFinancialUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ExtraFinancialDelete]";
		...
		private IDbCommand CreateParameters(SqlCommand cmd)
		{
			...
			p = cmd.Parameters.Add(Parameters.Allowances);
			p.SourceColumn = ColumnNames.Allowances;
			p.SourceVersion = DataRowVersion.Current;
			...
			p = cmd.Parameters.Add(Parameters.CalculationMethodID);
			p.SourceColumn = ColumnNames.CalculationMethodID;
			p.SourceVersion = DataRowVersion.Current;
